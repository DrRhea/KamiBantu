    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
      <div className="relative w-11/12 max-w-xl p-6 mx-auto bg-white rounded-lg shadow-lg">
        ...
        <div className="flex flex-col justify-center mt-8 space-y-4 md:flex-row md:justify-between md:space-y-0 md:space-x-4">
          <Link to="/anak" className="flex flex-col items-center justify-center w-full p-6 space-y-4 bg-purple-100 rounded-lg hover:bg-purple-200">
            <img src={anak} alt="Child Icon" className="w-24 h-24 md:w-32 md:h-32" />
            <span className="text-lg font-semibold">Anak</span>
          </Link>
          <Link to="/ortu" className="flex flex-col items-center justify-center w-full p-6 space-y-4 bg-purple-100 rounded-lg hover:bg-purple-200">
            <img src={ortu} alt="Adult Icon" className="w-24 h-24 md:w-32 md:h-32" />
