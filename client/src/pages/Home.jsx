...
const Home = () => {
  ...
  <iframe
    ...
    src="https://www.youtube.com/embed/hlWNRcGrwXA?autoplay=1&si=NeuwrHyZpuA8MuOb" 
      ...
      <div className="container items-center px-4 py-8 m-auto mt-5">
        <div className="flex flex-wrap pb-3 mx-12 md:mx-24 lg:mx-0">
          <div className="w-full p-2 lg:w-1/4 md:w-1/2">
            <div
              className="flex flex-col items-center justify-center px-4 py-16 text-center duration-300 bg-[#dedaf3] shadow-lg rounded-xl hover:bg-gray-50 hover:shadow-2xl group"
            >
